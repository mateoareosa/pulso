...
export class SalesService {
  ...
  public async processSale(command: unknown): Promise<{
    success: boolean;
    sale: SaleRecord;
    ...
    const ledgerKey = `${validCommand.tenantId}:${validCommand.idempotencyKey}`;
    ...
    const record: SaleRecord = {
      ...
      locationId: validCommand.locationId,
  ...
  public getSaleById(saleId: string): SaleRecord | undefined {
